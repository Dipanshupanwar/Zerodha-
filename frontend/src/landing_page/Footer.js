...
function Footer() {
    ...
    <div className='container mt-5'>
        <div className='row'>
            <div className='col'>
                <img src='/image/logo.svg' style={{width:"40%"}}></img>
...
<a href=''style={{ textDecoration: "none" }}> Referral programmeCareers</a><br/>
<a href=''style={{ textDecoration: "none" }}> Zerodha.tech</a><br/>
<a href=''style={{ textDecoration: "none" }}>ress & media </a><br/>
<a href=''style={{ textDecoration: "none" }}> Zerodha Cares (CSR)</a><br/>
            ...
            <div className='col'>
                <p>Account</p>
                <a href=''style={{ textDecoration: "none" }}>Open an account
              </a><br/>
...
<p>Investments in securities market are subject to market risks; read all the related documents carefully before investi</p>
